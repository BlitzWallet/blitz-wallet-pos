...
import { GlobalLendaSwapContext } from "./contexts/lendaswapContext";
import { HandleWalletInitializationProvider } from "./contexts/handleWallets";
    ...
    <GlobalPOSContext>
      <GlobalRescanLiquidSwaps>
        <GlobalSettingsDisplay>
          <GlobalLendaSwapContext>
            <HandleWalletInitializationProvider>
              <BrowserRouter>
                <NavigateScreen />
                <SettingsPage />
                <Routes>
